...
echo "   node${SRC} (${WALLET_SRC}): $($CLI_SRC getbalance 2>/dev/null || echo '?') BTC"
echo "   node${DST} (${WALLET_DST}): $($CLI_DST getbalance 2>/dev/null || echo '?') BTC"

echo ""
echo "╔══════════════════════════════════════════════╗"
echo "║  Done! Open the dashboard to explore the     ║"
echo "║  new block and transaction.  ./start.sh      ║"
echo "╚══════════════════════════════════════════════╝"
echo ""
